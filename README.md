...
Se recomienda que el repositorio tenga commits separados, por ejemplo:

- `feat: crear entidad Producto y enum Categoria`
- `feat: agregar repository y service`
- `feat: agregar DTOs y validaciones`
- `feat: agregar controller REST`
- `feat: agregar manejo global de excepciones`
- `feat: integrar Swagger`
- `docs: agregar README y capturas`
